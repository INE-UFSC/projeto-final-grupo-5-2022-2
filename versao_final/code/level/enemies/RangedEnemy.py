...
from code.level.damage.PlayerDamageArea import PlayerDamageArea
from code.level.enemies.BasicEnemy import Enemy
from code.level.enemies.EnemyStatus import RangedStatus
...
class RangedEnemy(Enemy, ABC):
    ...
    def launch_projectile(self):
        ...
        projectile = PlayerDamageArea(self.hitbox.center, self.projectile_sprite, self.projectile_damage,
                                      self.projectile_speed, self.get_player_distance_direction()[1])
